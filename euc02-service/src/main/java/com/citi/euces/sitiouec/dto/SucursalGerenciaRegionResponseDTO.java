...
public class SucursalGerenciaRegionResponseDTO {
	 ...
	 * @param rK
	 */
	public SucursalGerenciaRegionResponseDTO(String dIVISION, String rEGION, double vENTAS, double mONTO,
	...
	public SucursalGerenciaRegionResponseDTO() {
