...
public class SucursalRegionalGerenciaResponseDTO {
	 ...
	 * 
	 */
	public SucursalRegionalGerenciaResponseDTO() {
		super();
	}
	/**
	 * @param dIVISION
	 ...
	 * @param rK
	 */
	public SucursalRegionalGerenciaResponseDTO(String dIVISION, String dISTRITO, double vENTAS, double mONTO,
